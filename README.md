...
- Photos are processed entirely on the device.
- Photos are never uploaded to GitHub or any server.
- There are no accounts, advertisements, analytics, or public galleries.
- After the first successful load, the installed app works offline.
